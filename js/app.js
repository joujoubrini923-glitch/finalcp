...
(function () {
  ...
  const TITLES = {
    ...
    analytics: 'Analytics', achievements: 'Achievements', join: 'Join the Academy', parent: 'Parent Mode', submit: 'Submit a Solve', space: 'My Space', seasons: 'Seasons', admin: 'Admin Panel',
  };
  ...
  function parseHash() {
    ...
    if ((mm = h.match(/^\/join(?:#(apply|ask|trial))?$/))) return { name: 'join', param: mm[1] || null };
