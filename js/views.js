      ...
      body.innerHTML = `
        ...
        <section class="course-launch-card next-course-space-ad card reveal in" id="next-course-ad">
          <div class="course-launch-copy">
            ...
            <div class="course-facts"><span>${ic('calendar')}${U.esc(nextCourse.period)}</span><span>${ic('clock')}${U.esc(nextCourse.duration)}</span><span class="course-age-fact">${ic('users')}${U.esc(nextCourse.age)}</span></div>
            ${studentAvailabilityPickerHTML('next', nextCourse.availability)}
