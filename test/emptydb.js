...
const { window } = dom;
try { Object.defineProperty(window, 'crypto', { value: require('crypto').webcrypto, configurable: true, writable: true }); } catch (e) {}
...
(async () => {
  ...
  const routes = ['#/','#/students','#/groups','#/leaderboard','#/problems','#/contests','#/achievements','#/analytics','#/join','#/submit','#/admin','#/admin/requests','#/admin/verify'];
