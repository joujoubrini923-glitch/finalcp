  ...
  function tabSeasons(el) {
    ...
    el.innerHTML = `
      <div class="card reveal in">
        ...
        <p class="muted tiny" style="margin-top:6px">A season counts solves + contests inside its dates only. End a season to freeze its <b>Top 2</b> on the public Champion Wall (<a class="link-accent" href="#/champions">#/champions</a>). Only one season can be live.</p>
